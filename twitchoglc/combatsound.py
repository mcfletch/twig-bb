...
:mod:`twitchoglc.assets`, which is how commissioned or CC0 content replaces a
...
#: :mod:`twitchoglc.weapons`, because a weapon's model and a weapon's sound are
...
#: metres.  Much further than map ambience (:mod:`twitchoglc.speakers`): a
...
def _emitter(kind: str) -> audiomodel.AudioEmitter:
    ...
    :mod:`twitchoglc.speakers`: a shot across a level has to be audible,
